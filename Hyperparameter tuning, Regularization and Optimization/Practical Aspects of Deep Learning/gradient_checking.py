...
def gradient_check_n(parameters, gradients, X, Y, epsilon = 1e-7):
    ...
    if difference > 2e-7:
        print('\033[93m' + 'Mistake in backward propagation difference. Difference is: ' + str(difference) + '\033[0m')
    else:
        print('\033[92m' + 'Backward propagation calculation is correct. Difference is: ' + str(difference) + '\033[0m')
